 ...
 */
public class Map2ExcelTask extends Data2ExcelBaseTask {
     ...
     * @throws IOException
     */
    public Map2ExcelTask(SheetData data, Workbook template2007) throws IOException {
     ...
     * @throws IOException
     */
    public Map2ExcelTask(SheetData data, HSSFWorkbook template2003) throws IOException {
     ...
     * @throws IOException
     */
    public Map2ExcelTask(SheetData data, Workbook template2007, String sheetName) throws IOException {
     ...
     * @throws IOException
     */
    public Map2ExcelTask(SheetData data, HSSFWorkbook template2003, String sheetName) throws IOException {
     ...
     * @throws IOException
     */
    public Map2ExcelTask(SheetData data, Document document, String taskName) throws IOException {
