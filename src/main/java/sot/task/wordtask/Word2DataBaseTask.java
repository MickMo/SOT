 ...
 */
public abstract class Word2DataBaseTask<T> {
    private Word2DataBaseTask() {
    }
...
//    word -> bean
     ...
     */
    public Word2DataBaseTask(Document document, String[] targets, Workbook workBook2007) throws IOException {
     ...
     * @throws IOException Any IO exception before processing the excel file.
     */
    public Word2DataBaseTask(String taskName, String[] targets, Workbook workBook2007) throws IOException {
        this.workBook2007 = workBook2007;
     ...
     * @throws IOException Any IO exception before processing the excel file.
     */
    public Word2DataBaseTask(String taskName, String[] targets, Workbook workBook2007, String sheetName) throws IOException {
        this.workBook2007 = workBook2007;
        this.taskName = taskName;
        this.targets = targets;
     ...
     * @throws IOException Any IO exception before processing the excel file.
     */
    public Word2DataBaseTask(Document document, String[] targets, HSSFWorkbook workBook2003) throws IOException {
     ...
     * @throws IOException Any IO exception before processing the excel file.
     */
    public Word2DataBaseTask(String taskName, String[] targets, HSSFWorkbook workBook2003) throws IOException {
        this.workBook2007 = workBook2003;
        this.taskName = taskName;
        this.targets = targets;
    }
     ...
     * @throws IOException Any IO exception before processing the excel file.
     */
    public Word2DataBaseTask(String taskName, String[] targets, HSSFWorkbook workBook2003, String sheetName) throws IOException {
        this.workBook2007 = workBook2003;
        this.taskName = taskName;
        this.targets = targets;
        this.sheetName = sheetName;
